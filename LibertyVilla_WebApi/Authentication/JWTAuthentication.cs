    ...
    public class JWTAuthentication : IJWTAuthentication
    {
       // public string _key = "Wazobia Authorization key is used in authenticating application users into the application and likewise its it used in authorizing each of the users for proper management and security purpose";
        ...
        public string GenerateToken(LoginResponseModel model)
        {
            ...
            claims.Add(new Claim(ClaimTypes.NameIdentifier, model.ApplicationUserDto.Id.ToString()));
            claims.Add(new Claim(ClaimTypes.Email, model.ApplicationUserDto.Email));
            claims.Add(new Claim(ClaimTypes.Role, model.ApplicationUserDto.Role));     
